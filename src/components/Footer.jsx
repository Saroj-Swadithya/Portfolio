    ...
    <footer className="bg-gradient-to-r from-[#E3E4FA] to-[#FFE6E8] py-6 text-center text-darkLavender">
      ...
      <div className="flex flex-col items-center gap-1">
        <p className="text-darkLavender/80 text-sm md:text-base">
          ...
          <a href="https://www.buymeacoffee.com/sarojswadithya" target="_blank" rel="noopener noreferrer" className="ml-1 hover:text-[#e56e94] transition-colors">Buy me a coffee <span className="text-lg">☕</span></a>
        </p>  
